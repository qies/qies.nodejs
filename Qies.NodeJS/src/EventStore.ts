...
import { AggregateBase as BaseAggregate } from "./AggregateBase";
...
export class EventStore implements IEventStore {
    ...
    public async appendStream(aggregate: BaseAggregate, event: EventBase): Promise<void> {
        var params = {
    ...
    public async replayStream(aggregate: BaseAggregate): Promise<void> {
    ...
    public deserialize(eventType: string, data: any): EventBase {
        var factory = this.registeredEvents.get(eventType);
